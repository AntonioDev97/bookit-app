...
import { useUpdateRoomMutation } from "@/redux/api/room.api";
...
const UpdateRoom = ({ room }: Props) => {
    const [roomDetails, setRoomDetails] = useState({
        name: room?.name,
        price: room?.priceNight,
        description: room?.description,
        address: room?.address,
        category: room?.category,
        guestCapacity: room?.guestCapacity,
        numOfBeds: room?.numBeds,
        internet: room?.services?.internet,
        breakfast: room?.services?.breakfast,
        airConditioned: room?.services?.airConditioned,
        petsAllowed: room?.services?.petsAllowed,
        roomCleaning: room?.services?.roomCleaning,
    });
